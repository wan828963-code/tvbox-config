...
result += playUrl.substring(i).replace(/奇迹云/g, '');
break;
}
}
return result;
...
const snifferMatch = /http((?!http).){26,}?\.(m3u8|mp4|flv|avi|mkv|rm|wmv|mpg)?|http((?!http).){26,}\.(m3u8|mp4|flv|avi|mkv|rm|wmv|mpg)|http((?!http).)*?\/m3u8\?pt=m3u8.|http((?!http).)*?default.ixigua.com\/|http((?!http).)*?cdn-tos[^?]|http((?!http).)*?\/obj\/tos[^?]|http.*?\/player\/m3u8play.php\?url=.|http.*?\/player\/.*?[pP]lay.php\?url=.|http.*?\/playlist\/m3u8\/?vid=.|http.*?.php\?type=m3u8&.|http.*?\/download.aspx?.|http.*?\/api\/up_api.php?.|https.*?.66yk.cn./m;
...
str = "分类+全部=+电影=movie+连续剧=tvplay+综艺=tvshow+动漫=comic+4K=movie_4k+体育=tiyu\nclass+全部=+喜剧+爱情+恐怖+动作+科幻+剧情+战争+警匪+犯罪+动画+奇幻+武侠+冒险+枪战+悬疑+惊悚+经典+青春+文艺+微电影+古装+历史+运动+农村+伦理+情色+福利+三级+儿童+网络电影\narea+全部=+大陆+香港+台湾+美国+英国+法国+日本+韩国+德国+泰国+印度+西班牙+加拿大+其他\nyear+全部=+2025+2024+2023+2022+2021+2020+2019+2018+2017+2016+2015+2014+2013+2012+2011+2010+2009+2008+2007+2006+2005+2004+2003+2002+2001+2000";
}
